  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="relative max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        ...
        {/* Footer */}
        <footer className="mt-12 sm:mt-20 text-center space-y-3">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <a
              ...
              className="text-muted-foreground/50 hover:text-primary text-[10px] sm:text-xs uppercase tracking-wider transition-colors flex items-center gap-1"
            >
